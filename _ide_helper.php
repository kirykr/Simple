...
namespace {
    ...
    class Cart extends \Gloudemans\Shoppingcart\Facades\Cart{
         ...
         * @static 
         */
        public static function add($id, $image = null, $name = null, $qty = null, $price = null, $options = array()){
            return \Gloudemans\Shoppingcart\Cart::add($id, $image, $name, $qty, $price, $options);
        }
