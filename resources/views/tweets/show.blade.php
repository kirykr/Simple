...
<div class="page-header">
        ...
        <form action="{{ route('tweets.destroy', $tweet->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('tweets.edit', $tweet->id) }}"><i class="fa fa-edit"></i> Edit</a>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-link" href="{{ route('tweets.index') }}"><i class="fa fa-backward"></i>  Back</a>
