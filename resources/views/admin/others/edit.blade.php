...
{{-- @section('header') --}}
    <div class="page-header">
        <h1><i class="fa fa-edit"></i> Others / Edit #{{$other->id}}</h1>
    </div>
{{-- @endsection --}}
    ...
    <div class="row">
        ...
        {{-- <form action="{{ route('admin.others.update', $other->id) }}" method="POST">  --}}   
            {!! Form::model($other,['action' => ['OtherController@update', $other->id], 'method' => 'PATCH', 'files'=>true]) !!}
           {{--
